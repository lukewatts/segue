    ...
    class Redux_Framework_sample_config {
        ...
        public function setSections() {
            ...
            $this->sections[] = array(
              ...
              'heading'   => __('Footer Settings', 'redux-framework-demo'),
              'desc'      => __('<p class="description">Enter footer text.</p>', 'redux-framework-demo'),
              'fields'    => array(
                  array(
                        'id'        => 'copyright',
                        'type'      => 'editor',
                        'title'     => __('Copyright Info', 'redux-framework-demo'),
                        'subtitle'  => __('Enter your copyright info here.', 'redux-framework-demo'),
                        'default'   => '&copy; 2014',
                    ),
                  array(
                        'id'        => 'footer-text',
                        ...
                        'subtitle'  => __('Enter your footer text here.', 'redux-framework-demo'),
                        'default'   => 'Theme built by the <strong>AMAZINGLY AWESOME</strong> <a href="http://luke-watts.com" target="_blank">Luke Watts</a>!',
                    ),
//                     array(
//                         'id'        => 'opt-text-email',
//                         'type'      => 'text',
...
//                     ),
        ...
        public function setArguments() {
            ...
            $this->args = array(
                ...
                'opt_name'          => 'options_data',                      // This is where your data is stored in the database and also becomes your global variable name.
                'display_name'      => ucfirst( $theme->get( 'Name' ) ),    // Name that appears at the top of your panel
                'display_version'   => $theme->get( 'Version' ),         // Version that appears at the top of your panel
                'menu_type'         => 'submenu',                           //Specify if the admin menu should appear or not. Options: menu or submenu (Under appearance only)
                'allow_sub_menu'    => true,                                // Show the sections below the admin menu item or not
                'menu_title'        => __( 'Segue Options', 'redux-framework-demo' ),
                'page_title'        => __( 'Segue Options', 'redux-framework-demo' ),
                ...
                'global_variable'   => 'data',                  // Set a different name for your global variable other than the opt_name
                ...
                'page_slug'         => 'segue_options',         // Page slug used to denote the panel
            ...
            $this->args['share_icons'][] = array(
                'url'   => 'https://github.com/lukewatts/segue',
                'title' => 'Find the project on Github',
                'icon'  => 'el-icon-github'
                //'img'   => '', // You can use icon OR img. IMG needs to be a full URL.
            );
            $this->args['share_icons'][] = array(
                'url'   => 'http://twitter.com/LukeWatts85',
                'title' => 'Follow me on Twitter',
                'icon'  => 'el-icon-twitter'
            );
            $this->args['share_icons'][] = array(
                'url'   => 'http://www.linkedin.com/in/lukewatts',
            ...
            if (!isset($this->args['global_variable']) || $this->args['global_variable'] !== false) {
                ...
                $this->args['intro_text'] = sprintf(__('<p>Do all of your optiony stuff here \'n\' stuff...</p>', 'redux-framework-demo'), $v);
            } else {
